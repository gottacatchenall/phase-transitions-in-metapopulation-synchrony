...
plt1 = get_pop_points(x_vals, y_vals, 2, 2, kernel=exp_kern,yaxis=T)
plt2 = get_pop_points(x_vals, y_vals, 8, 2, kernel=exp_kern, yaxis=F, xaxis=F)
plt3 = get_pop_points(x_vals, y_vals, 15, 2, kernel=exp_kern, yaxis=F, xaxis=F)
plt4 = get_pop_points(x_vals, y_vals, 2, 2, kernel=gauss_kern, yaxis=T,xaxis=T,kernel_name="Gauss")
plt5 = get_pop_points(x_vals, y_vals, 8, 2, kernel=gauss_kern, xaxis=T,kernel_name="Gauss")
plt6 = get_pop_points(x_vals, y_vals, 15, 2, kernel=gauss_kern, xaxis=T, yaxis=F, kernel_name="Gauss")
